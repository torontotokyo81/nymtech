...
impl Signature {
    pub fn sig1(&self) -> &G1Projective {
        &self.0
    }

    pub fn sig2(&self) -> &G1Projective {
        &self.1
    }
...
mod tests {
    ...
    use crate::scheme::verification::{prove_bandwidth_credential, verify, verify_bandwidth_credential};
    ...
    fn verification_on_two_private_attributes() {
        ...
        assert!(verify_bandwidth_credential(
            &params,
            &keypair1.verification_key(),
            &theta1,
            &[],
